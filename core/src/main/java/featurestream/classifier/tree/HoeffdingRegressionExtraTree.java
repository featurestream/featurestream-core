...
public class HoeffdingRegressionExtraTree extends HoeffdingRegressionTree {

	private static final Logger log = LoggerFactory.getLogger(HoeffdingRegressionExtraTree.class);	

	public HoeffdingRegressionExtraTree(Schema schema, String target, Properties props) {
